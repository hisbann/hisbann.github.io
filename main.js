...
const tempeIcon = document.getElementById("tempe");
...
darkMode.addEventListener("click", function () {
  ...
  if (this.classList.contains('bx-sun')) {
    ...
    dashboard.style.transition = '.3s'
    settings.style.transition = '.3s'
    contacts.style.transition = '.3s'
    tempeIcon.style.fill = 'black'
    footerr.style.color = 'black'
    cel.style.color = 'black'
    fe.style.color = 'black'
    re.style.color = 'black'
    ke.style.color = 'black'
    btn1.style.stroke = '#fff'
    btn2.style.stroke = '#fff'
    btn3.style.stroke = '#fff'
    btn4.style.stroke = '#fff'
    btn1.style.fill = '#2563eb'
    btn2.style.fill = '#2563eb'
    btn3.style.fill = '#2563eb'
    btn4.style.fill = '#2563eb'
    darkMode.style.animation = 'zoom'
    container.style.transition = '.3s'
  } else {
    container.style.background = '#1e293b'
    tempeIcon.style.fill = 'white'
    container.style.transition = '.3s'
    footerr.style.color = 'white'
    profile.style.background = '#1e293b'
    dashboard.style.background = '#1e293b'
    settings.style.background = '#1e293b'
    contacts.style.background = '#1e293b'
    profile.style.transition = '.3s'
    dashboard.style.transition = '.3s'
    settings.style.transition = '.3s'
    contacts.style.transition = '.3s'
    ...
    btn3.style.stroke = '#fff'
    btn4.style.stroke = '#fff'
    btn1.style.fill = '#1f2937'
    btn2.style.fill = '#1f2937'
    btn3.style.fill = '#1f2937'
    btn4.style.fill = '#1f2937'
